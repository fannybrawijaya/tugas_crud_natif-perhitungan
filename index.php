...
<td>
                <a href="tambah.php?id_gaji=<?= $row['id_gaji'] ?>">Tambah Data Karyawan</a>
            </td>
    <table border="1" cellpadding="10" cellspasing="0">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="hapus_total.php?id_gaji=<?= $row['id_gaji'] ?>">hapus</a>
            </td>
            <td>
                <a href="edit.php?id_gaji=<?= $row['id_gaji'] ?>">edit</a>
            </td>
